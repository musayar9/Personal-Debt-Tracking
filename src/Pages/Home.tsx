    ...
    <div className="max-w-3xl mx-auto my-24">
      <div className="flex flex-col gap-4 items-center justify-center">
        ...
        <p className="text-xl font-semibold tracking-widest text-slate-500">
          ...
          your debts with the PDT App! Create your digital wallet, easily track
          your debts, and schedule installments as needed. Plus, at the end of
          each month, review your payment plan with our monthly debt tracking
          feature to ensure timely payments. With PDT, managing your debts has
          never been easier!
        </p>
      </div>
